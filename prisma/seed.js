        ...
        for (let i = 0; i < 20; i++) {
            yield prisma.user.create({
                data: {
                    ...
                    createdAt: new Date(),
                    updatedAt: new Date(),
                    stripeCustomerId: faker_1.faker.datatype.uuid(),
                    mpesaReferenceId: faker_1.faker.datatype.uuid(),
                    companyName: faker_1.faker.company.name(),
                    companySize: `${faker_1.faker.datatype.number({ min: 1, max: 10 })}-${faker_1.faker.datatype.number({ min: 11, max: 50 })} employees`,
                    companyLocation: faker_1.faker.address.country(),
                    companyWebsite: faker_1.faker.internet.url(),
        ...
        for (let i = 0; i < 20; i++) {
            ...
            yield prisma.payment.create({
                data: {
                    ...
                    payment_status: faker_1.faker.helpers.arrayElement([
                    ...
                    transactionId: faker_1.faker.datatype.uuid(),
                },
            });
        }
        // Seed Accounts
